...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premier Crèche, Nursery & Primary school in Lugbe, Abuja blending Nigerian, British and Montessori curricula. Nurturing minds since 2009." },
      { name: "author", content: "Diamond Standard Basic School" },
      { property: "og:title", content: "Diamond Standard Basic School" },
